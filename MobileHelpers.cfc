<cfcomponent output="false" mixin="controller">
	...
	<cffunction name="isMobile" access="public" output="false" hint="Detects if the current request comes from a mobile device. Taken from http://detectmobilebrowser.com/download/coldfusion">
		<cfset var loc = {}>
